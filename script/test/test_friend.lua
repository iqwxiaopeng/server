...
local function test(pid1,pid2)
	...
	local pos = findintable(player2.frienddb.applyerlist,pid1)
	assert(pos)
	player2.frienddb:reject_addfriend(pid1)
	pos = findintable(player2.frienddb.applyerlist,pid1)
	assert(pos==nil)
	player1.frienddb:apply_addfriend(pid2)	
	pos = findintable(player2.frienddb.applyerlist,pid1)
	assert(pos==nil)
	...
	pos = findintable(player1.frienddb.frdlist,pid2)
	assert(pos)
	pos = findintable(player2.frienddb.frdlist,pid1)
	assert(pos)
